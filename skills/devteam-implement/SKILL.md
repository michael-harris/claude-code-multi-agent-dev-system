---
name: devteam-implement
description: Execute implementation work - plans, sprints, tasks, or ad-hoc work.
argument-hint: [task] [--sprint <id>] [--all] [--task <id>] [--eco] [--skip-interview] [--type <type>] [--model <model>]
user-invocable: true
